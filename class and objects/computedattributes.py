...
# getattribute - called uncondotionally everytime when attribute value is requested.
# getatrr - called only when requested attribute cant be found in an object
# setattr - called wehn attribut value is set on the object 
# delattr - to delete an attrubute
# dir - called when the dir function is use in a object.